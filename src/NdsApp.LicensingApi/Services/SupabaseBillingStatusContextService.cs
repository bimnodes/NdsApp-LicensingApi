...
public sealed class SupabaseBillingStatusContextService : IBillingStatusContextService
{
    ...
    public SupabaseBillingStatusContextService(HttpClient httpClient, IOptions<SupabaseOptions> options)
    {
    ...
    public async Task<JsonElement> GetContextAsync(GetBillingStatusRequest request, CancellationToken cancellationToken)
    {
        ...
        using var response = await _httpClient.PostAsJsonAsync(
            "/rest/v1/rpc/nds_get_billing_status_context",
            payload,
            JsonOptions,
            cancellationToken);
        ...
        {
            throw new SupabaseRpcException("Supabase RPC 'nds_get_billing_status_context' failed.", (int)response.StatusCode, responseBody);
        }
